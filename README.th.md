...
### 🔑 การตั้งค่าความลับและ Token (Credentials)
ดูคู่มือฉบับย่อได้ที่: [**`config/README.md`**](config/README.md) เพื่อใส่ GitHub Personal Access Token (`.env`) และ Ed25519 SSH Key
